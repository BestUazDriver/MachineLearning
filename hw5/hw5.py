...
if __name__ == '__main__':
    ...
    # ЛКМ добавляет точку к одному классу (обозначаемому 0), ПКМ - к другому классу (обозначаемому 1).
    # Нужно, чтобы были представлены точки из обоих классов, после чего нужно нажать Enter!