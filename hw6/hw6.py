...
def calculate_total_distance(route, distance_matrix):
    ...
    total_distance += distance_matrix[route[-1]][route[0]]  # Возвращение к стартовому городу
...
def crossover(parent1, parent2):
    ...
    child = child + [parent1[0]]  # Убеждаемся, что маршрут закончился в стартовом городе
    return child
...
if __name__ == "__main__":
    num_cities = 7 # Кол-во городов
    STARTING_CITY = 0  # Номер стартового города
    population_size = 100
    generations = 1000
